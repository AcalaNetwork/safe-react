    ...
    <Container data-testid={'load-safe-address-step'}>
      <Block margin="md">
        <Paragraph color="primary" noMargin size="lg">
          You are about to add an existing {chainId == '686' ? 'Karura Safe' : 'Acala Safe'} on <NetworkLabel />. First,
          choose a name and enter the Safe address. The name is only stored locally and will never be shared with Acala
      ...
      <Block margin="sm">
        <Paragraph color="primary" noMargin size="lg">
          ...
          {' and '} */}
          <StyledLink href="https://acala.network/privacy" rel="noopener noreferrer" target="_blank">
            privacy policy
          </StyledLink>
          .
        </Paragraph>
